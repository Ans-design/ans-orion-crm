...
import { CarnetAutocopiantWorkspace } from '@/components/administration/pricing-rules/CarnetAutocopiantWorkspace';
import '@/components/backoffice-v2/admin-backoffice.css';

export default function CarnetAutocopiantAdminPage() {
  return (
...
function Content() {
  ...
  return <CarnetAutocopiantWorkspace canEdit={canEdit} />;
}
