...
import { StampFormatsWorkspace } from '@/components/administration/pricing-rules/StampFormatsWorkspace';
import '@/components/backoffice-v2/admin-backoffice.css';

export default function TamponsAdminPage() {
  return (
...
function Content() {
  ...
  return <StampFormatsWorkspace canEdit={canEdit} />;
}
