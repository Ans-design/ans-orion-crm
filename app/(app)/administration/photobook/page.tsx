...
import { PhotobookWorkspace } from '@/components/administration/pricing-rules/PhotobookWorkspace';
import '@/components/backoffice-v2/admin-backoffice.css';

export default function PhotobookAdminPage() {
  return (
...
function Content() {
  ...
  return <PhotobookWorkspace canEdit={canEdit} />;
}
