...
import { TextileAdminWorkspace } from '@/components/administration/textile/TextileAdminWorkspace';
import '@/components/backoffice-v2/admin-backoffice.css';

export default function TextileAdminPage() {
  return (
...
function Content() {
  ...
  return <TextileAdminWorkspace canEdit={canEdit} />;
}
