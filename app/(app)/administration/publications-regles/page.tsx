...
import { PublicationPricingWorkspace } from '@/components/administration/pricing-rules/PublicationPricingWorkspace';
import '@/components/backoffice-v2/admin-backoffice.css';

export default function PublicationsReglesAdminPage() {
  return (
