...
import { PhotoFormatsWorkspace } from '@/components/administration/pricing-rules/PhotoFormatsWorkspace';
import '@/components/backoffice-v2/admin-backoffice.css';

export default function FormatsPhotoAdminPage() {
  return (
...
function Content() {
  ...
  return <PhotoFormatsWorkspace canEdit={canEdit} />;
}
