...
import { CadrePhotoWorkspace } from '@/components/administration/pricing-rules/CadrePhotoWorkspace';
import '@/components/backoffice-v2/admin-backoffice.css';

export default function CadrePhotoAdminPage() {
  return (
...
function Content() {
  ...
  return <CadrePhotoWorkspace canEdit={canEdit} />;
}
