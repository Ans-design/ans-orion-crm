...
import { TiragePhotoWorkspace } from '@/components/administration/pricing-rules/TiragePhotoWorkspace';
import '@/components/backoffice-v2/admin-backoffice.css';

export default function TiragePhotoAdminPage() {
  return (
...
function Content() {
  ...
  return <TiragePhotoWorkspace canEdit={canEdit} />;
}
