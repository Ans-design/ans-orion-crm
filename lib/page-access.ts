...
export const PAGE_ACCESS_RULES: PageAccessRule[] = [
  ...
  { path: '/machines', roles: ['admin', 'manager', 'production', 'conducteur', 'technicien'] },
  ...
  { path: '/production/dechets', roles: ['admin', 'manager', 'production'] },
  ...
  { path: '/planning', roles: ['admin', 'manager', 'production', 'conducteur', 'faconnage'] },
  { path: '/equipe/taches', roles: ['admin', 'manager', 'production', 'conducteur', 'faconnage', 'designer'] },
